        ...
        <CardContent className="space-y-6">
          <div>
            ...
            <div className="flex justify-between gap-1">
              <Button
                variant="outline"
                className="w-23 cursor-default hover:bg-white hover:text-primary rounded-lg shadow-sm text-sm"
              >
          ...
          <div>
            <label className="text-sm font-semibold text-card-foreground mb-2 block">Перша буква</label>
            <Popover>
